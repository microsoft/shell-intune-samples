...
############################################################################################
##
## Script to enable Apple Mobile File Integrity (AMFI)
##
############################################################################################
...
# Define variables
appname="EnableAppleMobileFileIntegrityAMFI"
...
echo "$(date) | Apple Mobile File Integrity (AMFI) is enabled or already enabled. Closing script..."
}
