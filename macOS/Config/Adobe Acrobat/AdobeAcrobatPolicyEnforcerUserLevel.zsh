...
# Define variables
appname="AdobeAcrobatPolicyEnforcerUserLevel"                                  # The name of our script
...
create_value "DC:Access:bShowKeyboardSelectionCursor" bool true "$plist"

# [ADD/UPDATE] UnifiedShare - Root
create_value "DC:UnifiedShare:bLastAttachLinkMode" bool true "$plist"

# [ADD/UPDATE] FormsPrefs - cRuntimeBGIdleColor
create_value "DC:FormsPrefs:cRuntimeBGIdleColor:bRuntimeHighlight" bool true "$plist"

# [ADD/UPDATE] Originals - Root (Example commented)
# create_value "DC:Originals:bDisplayAboutDialog" bool true "$plist"
create_value "DC:Originals:bAllowOpenFile" bool true "$plist"

# [ADD/UPDATE] JSPrefs - Root
create_value "DC:JSPrefs:bEnableJS" bool true "$plist"

# [ADD/UPDATE] Security - cDigSig - cCustomDownload (Example commented)
# create_value "DC:Security:cDigSig:cCustomDownload:bAskBeforeInstalling" bool true "$plist"

# [ADD/UPDATE] Security - cDigSig - cAdobeDownload (Example commented)
# create_value "DC:Security:cDigSig:cAdobeDownload:bLoadSettingsFromURL" bool true "$plist"

# [ADD/UPDATE] TrustManager - Root (Example commented)
create_value "DC:TrustManager:bTrustCertifiedDocuments" bool true "$plist"
# create_value "DC:TrustManager:bTrustOSTrustedSites" bool true "$plist"
