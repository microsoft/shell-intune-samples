...
############################################################################################
##
## Script to disable Internet Sharing
##
############################################################################################
...
# Define variables
appname="DisableInternetSharing"
...
echo "$(date) | Underlying service of Internet Sharing is now disabled or already disabled. Closing script..."
}
