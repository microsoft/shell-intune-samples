...
############################################################################################
##
## Script to install the latest [Google Drive]
## 
## VER 3.0.1
##
## Change Log
...
weburl="https://dl.google.com/drive-file-stream/GoogleDrive.dmg"              # What is the Azure Blob Storage URL?
appname="Google Drive"                                                        # The name of our App deployment script (also used for Octory monitor)
app="Google Drive.app"                                                        # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/GoogleDrive"             # The location of our logs and last updated data
processpath="/Applications/Google Drive.app/Contents/MacOS/Google Drive"      # The process name of the App we are installing
...
function downloadApp () {
    ...
    cd "$tempdir"
    curl -f -s --connect-timeout 30 --retry 5 --retry-delay 60 -L -o "GoogleDrive.dmg" "$weburl"
    if [ $? == 0 ]; then
