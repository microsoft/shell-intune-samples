...
############################################################################################
##
## Script to install the latest [Firefox]
## 
## VER 3.0.1
##
## Change Log
...
weburl="$resolved_url"              # What is the Azure Blob Storage URL?
appname="Firefox"                                                        # The name of our App deployment script (also used for Octory monitor)
app="Firefox.app"                                                        # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/MozillaFirefox"             # The location of our logs and last updated data
processpath="/Applications/Firefox.app/Contents/MacOS/Mozilla Firefox"      # The process name of the App we are installing
terminateprocess="true"                                                       # Do we want to terminate the running process? If false we'll wait until its not running
autoUpdate="true"                                                             # Application updates itself, if already installed we should exit                                                         # Application updates itself, if already installed we should exit
