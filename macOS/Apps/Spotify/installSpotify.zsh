...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://download.scdn.co/SpotifyARM64.dmg" 
    else
    # This is x64 URL
    weburl="https://download.scdn.co/Spotify.dmg"   
fi

appname="Spotify"                                                      # The name of our App deployment script (also used for Octory monitor)
app="Spotify.app"                                                      # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/$appname"          # The location of our logs and last updated data
processpath="/Applications/$app/Contents/MacOS/Spotify"                # The process name of the App we are installing
