...
############################################################################################
##
## Script to install the latest [Global Protect]
##
## VER 4.0.0
##
## Change Log
...
vpn_portal="msftvpn-alt.ras.microsoft.com"
...
# Write Global Protect Plist

cat << EOF > /Library/Preferences/com.paloaltonetworks.GlobalProtect.settings.plist
