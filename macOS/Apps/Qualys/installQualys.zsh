...
############################################################################################
##
## Script to install the latest Qualys
##
## VER 4.0.1
##
## Change Log
##
## 2023-09-14   - Script customized for Qualys installation
...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://catlab.blob.core.windows.net/apps/QualysCloudAgent-ARM.pkg?sp=r&st=2022-08-25T12:37:30Z&se=2099-08-25T20:37:30Z&spr=https&sv=2021-06-08&sr=b&sig=4HnMlm3dA9dJICxnpadFGNXZE8RuyRDCdXyMb1Xt9G0%3D" 
    else
    # This is old x64 (Intel) URL
    weburl="https://catlab.blob.core.windows.net/apps/QualysCloudAgent-x64.pkg?sp=r&st=2022-08-25T12:37:30Z&se=2099-08-25T20:37:30Z&spr=https&sv=2021-06-08&sr=b&sig=4HnMlm3dA9dJICxnpadFGNXZE8RuyRDCdXyMb1Xt9G0%3D"   
fi
appname="QualysCloudAgent"                                                                              # The name of our App deployment script (also used for Octory monitor)
...
function downloadApp () {
    ...
    cd "$tempdir"
    curl -f -s --connect-timeout 30 --retry 5 --retry-delay 60 --compressed -L -o "QualysCloudAgent.pkg" "$weburl"
    if [[ $? == 0 ]]; then
