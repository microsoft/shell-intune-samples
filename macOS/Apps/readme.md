...
The scripts in this section are mostly related to app installation via the [Intune Shell Scripting](https://docs.microsoft.com/en-us/mem/intune/apps/macos-shell-scripts). There are a number of reasons why you might want to use the Scripting Agent to handle installation.
