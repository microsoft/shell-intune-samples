...
.NOTES
    ...
    Requires Microsoft.Graph module for -TenantId functionality.
#>
...
function Push-ProfileToIntune {
    ...
    if (-not (Get-Module -ListAvailable -Name Microsoft.Graph.DeviceManagement)) {
        Write-Host ""
        Write-Host "Microsoft.Graph.DeviceManagement module is required for Intune push." -ForegroundColor Yellow
        Write-Host "Install it with: Install-Module Microsoft.Graph -Scope CurrentUser" -ForegroundColor Yellow
        throw "Missing required module: Microsoft.Graph.DeviceManagement"
    }
