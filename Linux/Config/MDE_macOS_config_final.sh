...
# Antivirus Settings for MacOS
    # Real-time protection, Cloud-delivered protection, Automatic sample submission, Diagnostic data collection, Folders excluded from scan, Files excluded from scan, File types excluded from scan. Processes excluded from scan
    # https://docs.microsoft.com/en-us/mem/intune/protect/antivirus-microsoft-defender-settings-macos
