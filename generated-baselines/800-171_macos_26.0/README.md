...
macOS 26.0: Security Configuration - 800-171

This guide describes the actions to take when securing a macOS 26.0 system against the 800-171 security benchmark.
...
- `part-02-root` - context: **root**, rules: **54**
- `part-03-user` - context: **user**, rules: **1**

## Notes

- Supported rules generated: **145**
- Unsupported rules skipped: **33**
