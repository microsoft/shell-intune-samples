...
macOS 26.0: Security Configuration - hicp_lp

This guide describes the actions to take when securing a macOS 26.0 system against the hicp_lp security benchmark.
...
- `part-02-root` - context: **root**, rules: **33**
- `part-03-user` - context: **user**, rules: **1**

## Notes

- Supported rules generated: **124**
- Unsupported rules skipped: **22**
