# 800-53r5_high_macos_26.0

macOS 26.0: Security Configuration - 800-53r5_high

This guide describes the actions to take when securing a macOS 26.0 system against the 800-53r5_high security benchmark.
...
- `part-02-root` - context: **root**, rules: **79**
- `part-03-user` - context: **user**, rules: **1**

## Notes

- Supported rules generated: **170**
- Unsupported rules skipped: **53**
