...
macOS 26.0: Security Configuration - cis_lvl1

This guide describes the actions to take when securing a macOS 26.0 system against the cis_lvl1 security benchmark.

## Generated policy parts

- `part-01-root` - context: **root**, rules: **90**
- `part-02-root` - context: **root**, rules: **1**
- `part-03-user` - context: **user**, rules: **2**

## Notes

- Supported rules generated: **93**
- Unsupported rules skipped: **5**
