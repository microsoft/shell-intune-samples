...
normalized_output="$(normalize_output "$raw_output")"
emit_string_field "os_camera_disable" "$normalized_output"
...
normalized_output="$(normalize_output "$raw_output")"
emit_int_field "os_directory_services_configured" "$normalized_output"
...
normalized_output="$(normalize_output "$raw_output")"
emit_string_field "os_hibernate_mode_destroyfvkeyonstandby_enable" "$normalized_output"
...
normalized_output="$(normalize_output "$raw_output")"
emit_int_field "os_hibernate_mode_intel_enable" "$normalized_output"
