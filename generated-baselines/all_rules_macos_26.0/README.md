# all_rules_macos_26.0

macOS 26.0: Security Configuration - all_rules

This guide describes the actions to take when securing a macOS 26.0 system against the all_rules security benchmark.
...
- `part-03-root` - context: **root**, rules: **59**
- `part-04-user` - context: **user**, rules: **2**

## Notes

- Supported rules generated: **241**
- Unsupported rules skipped: **92**
