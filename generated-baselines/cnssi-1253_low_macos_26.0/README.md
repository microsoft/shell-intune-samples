# cnssi-1253_low_macos_26.0

macOS 26.0: Security Configuration - cnssi-1253_low

This guide describes the actions to take when securing a macOS 26.0 system against the cnssi-1253_low security benchmark.
...
- `part-03-root` - context: **root**, rules: **14**
- `part-04-user` - context: **user**, rules: **2**

## Notes

- Supported rules generated: **196**
- Unsupported rules skipped: **52**
