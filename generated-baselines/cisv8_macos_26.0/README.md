...
macOS 26.0: Security Configuration - cisv8

This guide describes the actions to take when securing a macOS 26.0 system against the cisv8 security benchmark.
...
- `part-02-root` - context: **root**, rules: **67**
- `part-03-user` - context: **user**, rules: **2**

## Notes

- Supported rules generated: **159**
- Unsupported rules skipped: **20**
