...
macOS 26.0: Security Configuration - 800-53r5_moderate

This guide describes the actions to take when securing a macOS 26.0 system against the 800-53r5_moderate security benchmark.
...
- `part-02-root` - context: **root**, rules: **76**
- `part-03-user` - context: **user**, rules: **1**

## Notes

- Supported rules generated: **167**
- Unsupported rules skipped: **47**
