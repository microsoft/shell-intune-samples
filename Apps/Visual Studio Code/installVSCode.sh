...
# Define variables
tempdir="/tmp"
tempfile="/tmp/vscode.zip"                                                              # What filename are we going to store the downloaded files in?
weburl="https://go.microsoft.com/fwlink/?LinkID=620882"                      # What is the Azure Blob Storage URL?
appname="vscode"                                                                       # The name of our App deployment script
...
if [ $install == "yes" ]; then
    ...
    # wait for other downloads to finish
    waitForCurl
